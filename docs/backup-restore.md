...
| Owner agent pilot reference | Final SQLite notes/state archive | `/srv/shreyws/agents/archive/owner-agent-pilot-state-20260717-114527.tar.gz` | Borg file backup through `/srv/shreyws/agents` | Extract archive to a temporary directory; validate SQLite before any reference redeploy |
